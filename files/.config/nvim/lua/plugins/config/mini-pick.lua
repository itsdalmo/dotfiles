...
vim.keymap.set("n", "<leader>fr", [[<cmd>Pick oldfiles current_dir=true<cr>]], { desc = "Recent files (cwd)" })
vim.keymap.set("n", "<leader>fR", [[<cmd>Pick oldfiles<cr>]], { desc = "Recent files (all)" })
