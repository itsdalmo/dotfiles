...
```sh
/bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/itsdalmo/dotfiles/nixos/install.sh)"
```
...
```sh
$ sudo nixos-rebuild switch --flake github:itsdalmo/dotfiles/nixos#parallels-vm
```
...
$ sudo apt install ./wezterm-20230712-072601-f4abf8fd.Debian11.deb
$ rm ./wezterm-20230712-072601-f4abf8fd.Debian11.deb

# Install Jetbrains toolbox
$ curl -LO https://download.jetbrains.com/toolbox/jetbrains-toolbox-2.0.2.16660.tar.gz
$ echo "c3a50186d9a1d350a42e4972c9026e8fe63eb054488e88e8be104d9d2e0bf858 *jetbrains-toolbox-2.0.2.16660.tar.gz" | sha256sum --check
$ sudo tar -xzf jetbrains-toolbox-2.0.2.16660.tar.gz -C /opt
$ rm jetbrains-toolbox-2.0.2.16660.tar.gz
```
